...
<amp-lightbox id="vr" layout="nodisplay" scrollable="">
  ...
  <article>
    ...
    <hr /><br />
    <h2>VRとは?</h2>
    <p>皆さんはVRというものを体験したことはありますか? VRとはVirtual Reality(仮想現実)の略で、コンピュータが作った仮想空間を、まるで自分が本当にそこにいるかのように体験できる技術のことを指します。近年急速に発達してきた技術で、ビジネス・医療・エンターテインメントなどの幅広い分野で活用されています。皆さんも街中のVR体験コーナーに行列が出来ているのを見たことがあるのではないでしょうか。</p>
    <h2>医療でのVR</h2>
    <p>今回の企画では、医療に関係する以下のプログラムを実際に体験することが出来ます。</p>
...
<article>
  ...
  <hr /><br />
  <h2>1.アニメ「はたらく細胞」</h2>
  <p>昨年夏に放映されたアニメ「はたらく細胞」をご存知でしょうか? 人間の体内の細胞たちを擬人化し、病気になった時や怪我をした時、花粉症の時などに、体の中で一体何が起きているのかを分かりやすく、そして楽しく解説した作品です。なんと今回の五月祭では、この「はたらく細胞」の登場人物……いや「登場細胞」たちが医学部企画に遊びに来てくれました!</p>

  <h2>2.クイズラリー</h2>
  <p>せっかく細胞たちが遊びに来てくれたのに、なんと体の中である異変が起きてしまったようです。あまり長い間……例えば五月祭が終わるまで放っておくと大変なことになってしまうかもしれません! 健康のために、細胞たちは異変を解決しようと奮闘します。そこに、少し手助けをしてくれませんか?</p>
  <p>医学部企画の様々な場所に、解決の手がかりになるようなクイズが仕掛けられています。そのクイズのヒントを探したり答えを考えたりして、困っている細胞たちを助けてあげてください。健康のためご協力お願いします!</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <h2>ある救命実習からの脱出</h2>
  <h3>ストーリー</h3>
  <p>「あなたは、医学部生の一員としてこれから救急救命の実習に臨んでもらう。実習を行う教授は非常に厳しいことで有名であった。ミッションは、救急救命の実習をチーム全員で合格すること。TAが教えてくれる合格への手がかりを元にしながら、全てのテストを通過し、実習に合格することはできるのか―――」
  </p>
  <p>これは、あなたが実際にクイズやパズルを解きながら救急救命を行い、実習の合格を目指すゲームイベントです。</p>
  <h3>「救急救命×リアル脱出ゲーム」!?</h3>
  <p>みなさんの多くは、保健体育の授業や運転免許の学科で救命講習を受けたことがあるでしょう。胸骨圧迫、人工呼吸、AEDの使用等、これらの講習は教育的ではあるものの、臨場感に欠けていると感じた人も多いのではないでしょうか。私もその一人でした。「一般向けの救命講習を、臨場感を出して行うことはできないのか?」このような思いから本企画は始まりました。近年若者の間で大流行しているリアル脱出ゲームと救命講習を組み合わせることで、緊張感の中、救命に必要な手技をマスターできるプログラムを作ることを目指しました。制作に携わったメンバーはリアル脱出ゲームが好きな人ばかりです。諸所に工夫が凝らしてあるので、ぜひ存分に楽しんでいってください!</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <p>この企画では、そのような血圧に関する疑問に私たち医学部生が答えるとともに、みなさんの手で血圧を測っていただきます。</p>
  <p>ここでは、血圧の上と下とは何かについてのみ簡単にご説明します。</p>
  <h3>血圧の「上」と「下」とは</h3>
  <p>血圧を測定すると、120/80(上が120、下が80)などと上下2つの値が返ってきます。この上の値(ここでは120)は心臓が収縮して血液を送り出す時の血圧の値です。下の値(80)は心臓が弛緩して血液を吸い込む時の値です。すなわち、心臓がポンプのように収縮・弛緩を繰り返して血液を送り出しており、血管にかかる圧力が絶えず変動しているので、上下2つの値で血圧を表しているというわけですね。</p>
  <h3>みなさんにも医師になってもらいます!</h3>
  <p>本企画では、みなさんに血圧を測る側の立場にもなっていただきます。「血圧って機械で測るんじゃないの?」と思った方、実は聴診器といくつかの道具を使うだけで、電子機器を用いずに、上と下の血圧を両方測ることができるんです! この仕組みはとても良く出来ていて、筆者自身知ったときに感動しました。少しでも気になった方はぜひ本企画にご来場あれ。</p>
  <p>血圧を測る仕組みを理解して、実際に測定することができるようになれば、医師になった気分になること間違いなし!</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <hr /><br />
  <h2>1. 手術なんて関係ない?</h2>
  <p>手術、それは、自分には関係ないと思っていても意外に身近なものです。「おばあちゃんが膝の手術をした」「友達が入院し、手術を受けていた」など、身の回りの人の経験をきっかけに手術について考えさせられた機会を持つ方は多いのではないでしょうか。一生、手術と無関係に暮らせるのならそれが一番ですが、もし、自分が手術でしか治らない重い病気になってしまったら…? 手術は、人生の一大イベントとなりえるのです。そんな手術を仕事とする外科医に対して、尊敬の念を抱く人も少なくないでしょう。</p>
  <h2>2. 開腹手術体験</h2>
  <p>外科医になって最初に訓練するのが「糸結び」です。手術で余った糸をもらいうけ、白衣の胸ポケットに忍ばせ、少し時間が空いた時に、白衣のボタンや机、いすの足を利用して、糸をより糸のように交互に結んでいく練習をします。 手術を構成する手順の一つにすぎない糸結びですが、手術の時以外に練習できる数少ない技術の一つなのです。</p>
  <p>開腹手術体験では、そんな糸の結び方を始めとして、手術中に外科医が実際に行っていることを、手術で使う器具や練習キットを使って体験することが出来ます。糸と針での縫合・結び目の作り方など、医学生が優しく教えます!</p>
  <h2>3. 腹腔鏡手術体験</h2>
  <p>腹腔鏡手術体験では腹腔鏡を実際に操作して動かしてみることができます。</p>
  <p>腹腔鏡とは、体表から腹腔、つまりおなかの中の空間にさしこんで、内部を見る器具のことです。この腹腔鏡以外にも、様々な器具をおなかに開けた小さな穴に入れることにより、メスで身体を切り開くことなく、体の内部を見て様々な処置を行えます。腹腔鏡を用いた手術のことを腹腔鏡下手術といい、メスを使った開腹手術に比べ、患者さんの体への負担が小さいと言われています。</p>
  <p>あなたも外科医の才能に目覚めるかも? 是非お気軽にお越し下さい!</p>
  <p>なお今年度から開腹手術体験・腹腔鏡手術体験には整理券をお持ちの方のみご入場いただけます。配布詳細につきましてはweb・冊子などをご確認ください。</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <h3>実は知らない体の内部</h3>
  <p>皆さん小学校や中学校の理科の授業でヒトの体について学んだと思います。しかしそれらの授業で学ぶのはヒトの体のほんの一部だけです。実際「鼻の内部はどうなっているのか?」、「肋骨は何本あるのか?」、「盲腸はどの辺にあるのか?」などの質問に答えられるでしょうか? 自分の体の中のこと、もう少し詳しく知ってみたいと思いませんか?</p>
  <h3>企画内容について</h3>
  <p>そこでこの企画では、立体人体模型パズルを解いていただき、その後に医学部生がわかりやすく解説いたします。体の中なんて何も知らないという人から、ある程度知っているという人、はたまたパズルを楽しんでみたいという人まで、全ての人に新しい発見があるような解説を用意しております。また実際に立体人体模型パズルを組み立てることで体の内部のイメージができあがります。自分の体の中について、この機会に詳しくなってみてはいかがでしょうか?</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <hr /><br />
  <h3>えっ?鼓動を、かんじる?</h3>
  <p>「鼓動」と聞いて、何を連想しますか? それって心臓の動きのことだよね、何を今更……。そう言われてしまえばそれまでですが、一度立ち止まって考えて欲しいのです。「最後に、自分の鼓動を感じたのはいつですか?」</p>
  <p>この企画では、鼓動を手元の振動スピーカーを通して感じてもらいます。鼓動とは全身に血液を送り出している心臓の動きです。自らの手で鼓動に触れることで、今を生きている身体を実感してみてはいかがでしょうか。</p>
  <h3>企画内容について</h3>
  <p>本企画は、ワークショップ「心臓ピクニック」を催していらっしゃる坂倉先生(東京都市大学)らのグループに全面的に協力していただき実現しました。胸に当てた聴診器から送られた刺激は手元にある振動スピーカーに振動として伝わります。そのため、手元で鼓動をリアルタイムに感じることができるのです。30分ほどの時間の中で、安静時の鼓動を感じてもらった後に少し体を動かし、変化する鼓動も感じてもらいます。</p>
  <p>せっかくの医学部企画ですので、手術体験などを通して非日常を楽しむのもいいですが、普段から当然のように動いている「心臓」を改めて感じてみるのも悪くはないのでは…?</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <hr /><br />
  <h2>医療におけるエコー</h2>
  <p>近年、看護ケアを行う際のアセスメントや、看護技術の評価に超音波診断装置（エコー）が利用される場面が増えてきています。これまで視診や聴診、打診などにより身体内部の様子を推定しながらアセスメントを実施してきましたが、これに加えて直接体内を可視化するエコー検査を実施することで客観的かつ視覚的な情報を付加し、より詳細かつ正確な情報を得ることができるようになりました。このような進歩は、超音波画像の質が大幅に向上したこと、機器の軽量化が進んだことなどの技術革新によります。さらに、これを利用した看護領域における研究も進展しており、褥瘡のみならず、嚥下観察のための頸部エコー、便秘アセスメントのための大腸エコー、尿量計測のための膀胱エコーなど、看護へのエコーの適応がますます進んできています。一口にエコーといっても、組織内部を観察する方法と、大きさや血流の速度、組織の硬さなどを定量的に計測する方法の2通りの利用があります</p>
  <h3>企画内容について</h3>
  <p>この企画では、実際に自分の腕にエコーを当て、動脈の血流を観察できます。エコーでは、超音波（人が聞こえる音の周波数より高い周波数の音）の特性を利用して、組織内部を描出できます。血管内の血液などの液体は、音の反射がないため、エコー画像は真っ黒になります。</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <p>今年もナガイレーベン株式会社様のご協力の下、三種類の白衣を用意しました。本企画「白衣体験」では、好きな白衣を着て自由に記念写真を撮ることができます！白衣を着て、あなたも医師になりきってみませんか?
  <strong>なお、撮影はみなさんのカメラで行う予定ですので、カメラやスマートフォンなどの撮影機器をお忘れなく!!</strong>
  </p>
  <h3>ドクターコート</h3>
...
<article>
  ...
  <h3>意外に運動好き?</h3>
  <p>東大医学部生ともなれば、中高大とずっと教科書とにらめっこしながら過ごし、運動なんて全然ダメ…なんて、勝手なイメージを持たれがちですが、その蓋を開けてみれば、100名少々の医学科の中だけでも優に50名以上は運動部(医学部の部活を含む)に属しているんです。授業が終われば数人で連れ立ってジムへ行くという姿も珍しくありません。さらに、彼らの多くは大学から運動を始めたわけではなく、中高では運動部の部長であったなんて人も。</p>
  <p>勉学と運動は決して相反するものではないのです。</p>
  <h3>筋肉から親しむ「解剖学」</h3>
  <p>解剖学、と聞くと多くの方はカエルの解剖を思い受かべて、気持ち悪いな、よしてくれよ…。と敬遠してしまいがち。しかし、解剖学というのは体の成り立ちを詳しく見ることでそのほかのあらゆる医学を学ぶ基礎となる学問。あまり難しい展示で解剖学から距離を感じてしまうより、東大生医学部生の筋肉を使った世にも奇妙な解剖学講義から医学に親しんでみるのはいかがでしょうか?</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <h1>スケッチ企画</h1>
  <hr /><br />
  <h2>東大医学部生の「絵心」やいかに</h2>
  <h3>医学部に、まるで美術の授業のような時間があります</h3>
  <p>皆さんは、医学部で普段行われる授業についてどのようなイメージをお持ちでしょうか?医学生が避けては通れない試練(?)の一つに、「様々な臓器・身体の部位の一部を顕微鏡で見て、スケッチする」というものがあります(東大医学部では２〜４年生でこの授業が実施されます)。顕微鏡を覗きながら見えるものを絵に描くのは、非常に骨の折れる作業なのです。</p>
  <h3>医学生の描いた渾身の絵を御覧あれ!</h3>
  <p>この企画は、その医学生が苦労して描いたスケッチを手にとって、皆さんに是非私たちの日々の成果を見て頂きたいというものです。同じ東大医学部生でもそのスケッチは十人十色。まるで写真かと思うような美しいスケッチもあれば、中には抽象画のような、違う意味で芸術的な(?)スケッチもあるかもしれません。描いた人の苦労が感じられるような、小さいところまで丁寧に描かれたものもあるでしょう。描いた人の思いや苦労も想像しながら、同時に身体の神秘も感じて頂けたらと思います。</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <hr /><br />
  <h2>医学ドラマの世界に迫る</h2>
  <h3>あの名シーンを東大医学部生はどう見るのか?</h3>
  <p>医療ドラマといえば、いつの時代もドラマの花形。江戸時代にタイムスリップした医師の運命の物語「仁」や、"失敗しない"フリーランス女性医師の活躍を描く「ドクターX」などなど。しかし一方で、ドラマや映画の医療シーンには「今、何が起こっているんだろう?」「こんなことって本当にあるのかな」と様々な「?」があふれることもしばしば。「白い巨塔」の総回診のシーンに目を疑った方も少なくないのではないでしょうか? そこで、東大医学部生があなたの「?」に答えます!</p>
  <h3>企画内容について</h3>
  <p><!--実際にテレビで放映されたシーンを画面に流しつつ、-->そのシーンの解説を試みます。身近なお薬の話から現場で実装されている最先端医療の話まで、幅広いテーマについてご紹介できるように、解説するシーンについては厳選しました。また、普段はドラマを見ないという方にも楽しんでいただけるように、そのドラマのあらすじにも多少触れる予定です。この機会に、医学部生が観る医療ドラマの世界の一端をのぞいてみませんか?</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <h1>医学部史</h1>
  <hr /><br />
  <p>みなさんが今訪れている東京大学医学部は、どのような経緯を経て今あるのでしょうか。なぜ「東京大学医学部付属病院創立160周年」が「東京大学創立150周年」より早く来るのでしょうか。あるいはなぜ、一昔前まで、「医学部といえば第二外国語はドイツ語でしょ」という流れがあったのでしょうか。</p>
  <p>東大医学部は、江戸時代の神田・お玉ヶ池種痘所がその始まりと言われています。以来、大学東校、東京医学校、帝国大学医科大学、など名称を様々に変えながら、160年以上の歴史を積み重ねてきました。今回、その歴史の全貌をお見せすることはできませんが、現在のキャンパスに残る様々な「痕跡」をもとに、その歴史を少しだけ覗いてみようと思います。医学部本館の周りを少し歩くと、東大医学部ひいては日本の医学の歴史を作った偉人の業績をちょっぴり感じられるかもしれません。そんなささやかな楽しみを共有する展示です。</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <h1>医学部生の本棚</h1>
  <hr /><br />
  <h2>医学書の事なんか全然好きじゃないんだからねっ!</h2>
  <h3>医学生の本性を暴こう</h3>
  <p>皆さんは、難関試験を通った猛者たちが集う医学部医学科にどんな偏見をお持ちですか? 頭でっかちで勉強大好き、三度の飯より学術書、 ラブレターより参考書貰った方が嬉しい等、なんて訳はありません(一部除く)。ふたを開ければ、どこにでもいる学生です。恋バナ大好き、ゲーム大好き、スポーツ大好き、アニメ大好き、SF大好き! いやいや、嘘じゃないですよ</p>
  <h3>医学生の本棚見てみない?</h3>
  <p>じゃあこっちに来て、こいつらが今まで読んできた本を見てみて下さい。もちろん勉強の本も多いですけど、漫画やラノベに小説・雑誌もあります。医学書? ああ、学校指定の本が何冊かはありますね……。うわぁ、こんな本まで……(笑)。</p>
  <p>五月祭のこちら「医学書の事なんて全然好きじゃないんだからねっ!」では、彼らが受験期に“使ってよかった参考書”の傑作選にとどまらず、何となく医学・勉学に関係しそうな本から、ただ趣味全開の本まで幅広く展示しています。</p>
  <p>参考書が気になる学生も、付き添いのご家族も、理III生の実態が何となく気になるそこのあなたも! 束の間の休息もかねて、一度ご覧になってはいかがでしょう?</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <h1>公衆衛生へのいざない</h1>
  <hr /><br />
  <h2>この企画―公衆衛生へのいざないについて</h2>
  <p>この企画では、公衆衛生とはなにか、公衆衛生ではどのように物事を捉えるかをポスター形式でご紹介いたします。</p>
  <p>人の健康はその人だけで成り立つものでしょうか? 公衆衛生では人の健康を個人だけで成り立つとは考えず、社会や環境の影響を受けて成り立つものと考えます。公衆衛生では1人1人の健康を積み重ねた「人々の健康」を捉えることを目指しており、所得や職業など様々な社会的な要因が人々の健康に関係していることを科学的に示してきました。今回の五月祭企画では、私達に身近な「食と健康」に関するポスターを用いて、公衆衛生の考え方を簡単にご紹介いたします。</p>
  <p>公衆衛生では一般的な「医療」とは異なった視点から健康について捉えます。人々の健康を俯瞰的に見る公衆衛生の世界を、ぜひ覗いてみてください!</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <p>この企画では、昨年に東京大学の研究室から発表された論文をいくつか選び、ポスターの形式で紹介いたします。東京大学の医学系研究は、本郷キャンパスや東京大学病院、また各地の附置研究所で日々行われています。論文は、その日々の研究の営みが成果となり、専門雑誌などに掲載されたものです。それらは世界中で読まれ、新たな研究の基盤となっています。今回の五月祭企画では、神経病理学教室、免疫学教室、システムズ薬理学教室、健康環境医工学部門から発表された各論文の紹介ポスターと、東京大学病院のがん遺伝子パネル検査についての解説ポスターの計5つを用意しました。基礎研究から臨床まで幅広いテーマから選んでおります。ここ本郷の医学部建物内で、実際に毎日どのような研究が行われているか、ぜひ覗いてみてください!</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <p>災害の被害を受けた地域では、医療の需要が供給を上回り、他の地域からの医療支援が必要な状況となりえます。また自然災害だけでなく、大規模な事故やテロも、人為の災害であるとも言えるでしょう。さらに2020年のオリンピック・パラリンピックのような行事でも、大勢の人が集まるために、こうした災害が起きると大きな被害が懸念され、やはり同様の観点からの対策が重要となります。</p>
  <p>本企画では、そうした状況で提供される医療にまつわるトピックを、ポスター展示にて紹介します。</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <hr /><br />
  <h2>毒物を知ろう</h2>
  <p>本企画では、毒物とは何か、またなぜ毒物が我々の体に害を及ぼすのか、といったことを、薬物治療の基盤となる学問である薬理学的な観点から説明していきます。</p>
  <p>毒物と聞くと、とても危険で私たちの生活とは無関係に思えます。しかし、毒物と薬物は紙一重なのです。</p>
  <p>この企画を通じて、来場者の皆様が毒物の危険性を改めて認識してもらう助けになれると幸いです。古くから心不全などの治療薬として使用されている園芸植物のジギタリスも展示する予定ですので、そちらもぜひご覧になって下さい。</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <h2>今年は豪華二本立て</h2>
  <h3>最近話題の再生医療ってなに?</h3>
  <p>「再生医療って興味をひかれてるけど、いざ自分で調べてみてもiPSみたいな難しい単語が並んでいてさっぱり」そんな経験ありませんか? そこで本企画では、再生医療のフロンティアで活躍されている先生方をお招きして再生医療の今、そして未来を熱く語っていただきます</p>
  <h3>お医者さんってどうやって診断してるの?</h3>
  <p>「朝起きたら突然の発熱と倦怠感。それに少し体の節々に痛みもを感じる気がする」この1文からどんな病気を思い浮かべますか? 普段目にするお医者さんの診察の中には、実は予想をはるかに超えて奥深く面白い世界が眠っています。今回は、日ごろから臨床現場で活躍なさっている診断のプロたちをお招きして、臨床推論の世界に皆さんをいざないます</p>
  <ul class="lightbox-nav">
...
<article>
  ...
  <hr /><br />
  <h2>五月祭演奏会</h2>
  <p>本日は医学部五月祭企画にお越しくださり誠にありがとうございます。鉄門室内楽の会は、東京大学医学部の学生を中心とした音楽好きな学生が総勢60人以上所属し、活動を行っております。演奏する楽器は、弦楽器、管楽器、また合唱など多岐にわたります。オーケストラなど他の音楽系団体にも所属している会員も多く、それぞれのスタイルで音楽を楽しんでいるのが特徴です。年間の演奏活動としては、学園祭(五月祭、駒場祭)の他、学会や病院など外部での演奏も行っており、地域の皆様に好評を頂いております。今年も、下記の日時で五月祭演奏会を開催致します。どうぞお越しください!会員一同お待ちしております。</p>
  <h3>日程</h3>
...
<article>
  ...
  <p>さて、私たち美術部 ( 踏朱会 ) の活動としては大きく分 けて、制作と美術館巡りの2つがあります。  まず制作に関しては、油彩・水彩・鉛筆画などの作品 制作を中心に、展覧会へ向けて作品を制作しています。 昨年度は、五月祭、OB 組織である煉瓦の会の展覧会へ の出展、東大病院での煉瓦の会との合同展を行いました。</p>
  <p>美術館巡りに関しては、部員が行きたいところに 皆で行くといったかたちで、1・2 ヶ月に 1 回ほどの頻 度で行っています。大きな展覧会をメインに、規模が小さくても面白そうなものには行っており、4月始めには新歓として毎年新入生と行っています。直近の大きな展覧会としてはクリムト展などを考えています。</p>
